...
def rocch(tar_scores, nontar_scores, laplace=False):
...
class DET:
    ...
    def create_figure(self):
        ...
        ax.set_xticklabels(self.x_ticklabels, fontsize=12)

        ax.set_yticks(self.axes_transform(self.y_ticks))
        ax.set_yticklabels(self.y_ticklabels, fontsize=12)

        mpl.grid(True) # grid_color = '#b0b0b0'
        mpl.xlabel(self.x_label, fontsize=15)
        mpl.ylabel(self.y_label, fontsize=15)
